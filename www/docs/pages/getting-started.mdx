...
- Check out the [examples](https://github.com/Crescent617/mcp-go/tree/main/examples) for more complex use cases
- Join the discussion on [Discord](https://discord.gg/RqSS2NQVsY)
- Read the full documentation in the [README](https://github.com/Crescent617/mcp-go/blob/main/README.md)
